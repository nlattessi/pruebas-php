...
class BundlesControllerTest extends \Tests\TestCase
{
    use DatabaseMigrations;

    public function testShowShouldReturnAValidBundle()
    {
        ...
        // Check that two books exists in the response
    ...
    public function testAddBookShouldAddABookToABundle()
    {
    ...
    public function testRemoveBookShouldRemoveABookFromABundle()
    {
